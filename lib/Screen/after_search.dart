...
class After_Search extends StatefulWidget {
  final int num_page;

  const After_Search({super.key, required this.num_page});

  @override
  _After_SearchState createState() {
    return _After_SearchState();
  }
}

class _After_SearchState extends State<After_Search> {
  List _items = [];
